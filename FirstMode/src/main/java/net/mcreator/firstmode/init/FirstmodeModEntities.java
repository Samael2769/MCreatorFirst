...
public class FirstmodeModEntities {
	...
	public static final RegistryObject<EntityType<VulkanEntity>> VULKAN = register("vulkan",
			EntityType.Builder.<VulkanEntity>of(VulkanEntity::new, MobCategory.MONSTER).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(VulkanEntity::new).fireImmune().sized(1.5f, 2f));

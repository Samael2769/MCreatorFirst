...
public class VulkanEntity extends Monster {
	...
	public static void init() {
		SpawnPlacements.register(FirstmodeModEntities.VULKAN.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
